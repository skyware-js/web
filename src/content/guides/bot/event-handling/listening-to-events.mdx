...
Be aware that this will mean maintainng an open WebSocket connection that will receive all events occuring on the Bluesky network. This can be resource-intensive compared to polling.
