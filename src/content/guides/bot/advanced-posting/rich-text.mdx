...
By default, when you create a post, `@skyware/bot` parses your post's text to identify any mentions, hashtags, and URLs. However, in some cases, you may want more control over how a post is displayed. The [`RichText`](https://github.com/mary-ext/atcute/tree/trunk/packages/bluesky/richtext-builder) class provides a convenient interface for constructing a post containing rich text.
