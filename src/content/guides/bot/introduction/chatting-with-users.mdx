...
await conversation.sendMessage({
    text: new RichText().text("I love ").link("Skyware", "https://skyware.js.org").text("!")
});
```

If you already have a <Reference to="/docs/bot/classes/Profile" /> object, you can skip the <Reference to="/docs/bot/classes/Conversation" /> object and send and read messages directly.
