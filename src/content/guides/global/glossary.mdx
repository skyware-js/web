...
This glossary provides quick definitions for terms you might encounter while developing on the AT Protocol. It's [always open for contributions](https://github.com/skyware-js/web/tree/main/src/content/guides/all/introduction/glossary.mdx)!
